...
*WARNING*: Apple did not provide an ~SHA1~ for this Software Update on either page.
...
*WARNING*: Apple did not provide an ~SHA1~ for this Software Update.
...
*WARNING*
- There are 2 Software Updates here
- Both have a checksum
- However the one for Safari reports the download is invalid
  - Consider obtaining it from Software Update instead of the download
...
*WARNING*: The ~SHA1~ checksum of the downloaded file does not match with the checksum listed on the web page!
